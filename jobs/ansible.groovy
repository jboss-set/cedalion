...
downstreamCIJob('sso', downstreamProjectsPortOffsetstart++, "default")
...
//
downstreamRunnerJob('jws','playbook', 'runtimes_common', '/webserver/5.6.0/jws-5.6.0-application-server.zip,/webserver/5.6.0/jws-5.6.0-application-server-RHEL8-x86_64.zip')
downstreamRunnerJob('eap', 'playbook', 'runtimes_common', '/eap7/7.4.0/jboss-eap-7.4.0.zip')
downstreamRunnerJob('data_grid', 'infinispan', 'runtimes_common', '/datagrid/8.4.1/redhat-datagrid-8.4.1-server.zip')
